...
import static com.dtstack.flinkx.connector.doris.options.DorisKeys.DESERIALIZE_QUEUE_SIZE_KEY;
import static com.dtstack.flinkx.connector.doris.options.DorisKeys.DORIS_BATCH_SIZE_DEFAULT;
import static com.dtstack.flinkx.connector.doris.options.DorisKeys.DORIS_DESERIALIZE_ARROW_ASYNC_DEFAULT;
import static com.dtstack.flinkx.connector.doris.options.DorisKeys.DORIS_DESERIALIZE_QUEUE_SIZE_DEFAULT;
import static com.dtstack.flinkx.connector.doris.options.DorisKeys.DORIS_EXEC_MEM_LIMIT_DEFAULT;
import static com.dtstack.flinkx.connector.doris.options.DorisKeys.DORIS_REQUEST_CONNECT_TIMEOUT_MS_DEFAULT;
import static com.dtstack.flinkx.connector.doris.options.DorisKeys.DORIS_REQUEST_QUERY_TIMEOUT_S_DEFAULT;
import static com.dtstack.flinkx.connector.doris.options.DorisKeys.DORIS_REQUEST_READ_TIMEOUT_MS_DEFAULT;
import static com.dtstack.flinkx.connector.doris.options.DorisKeys.DORIS_REQUEST_RETRIES_DEFAULT;
...
import static com.dtstack.flinkx.connector.doris.options.DorisKeys.REQUEST_QUERY_TIMEOUT_S_KEY;
import static com.dtstack.flinkx.connector.doris.options.DorisKeys.REQUEST_READ_TIMEOUT_MS_KEY;
import static com.dtstack.flinkx.connector.doris.options.DorisKeys.REQUEST_RETRIES_KEY;
import static com.dtstack.flinkx.connector.doris.options.DorisKeys.REQUEST_TABLET_SIZE_KEY;
import static com.dtstack.flinkx.connector.doris.options.DorisKeys.TABLE_KEY;
import static com.dtstack.flinkx.connector.doris.options.DorisKeys.USER_NAME_KEY;
import static com.dtstack.flinkx.connector.doris.options.DorisKeys.WRITE_MODE_KEY;
