...
import com.dtstack.flinkx.connector.hbase2.conf.HBaseConfigConstants;
...
public class HBaseInputFormatBuilder extends BaseRichInputFormatBuilder<HBaseInputFormat> {
    ...
    public static HBaseInputFormatBuilder newBuild(HBaseTableSchema hbaseSchema) {
        HBaseInputFormat format = new HBaseInputFormat(hbaseSchema);
