...
import com.dtstack.flinkx.connector.hbase2.util.HBaseHelper;
...
public class HBaseInputFormat extends BaseRichInputFormat {
    ...
    public HBaseInputFormat(HBaseTableSchema hbaseSchema) {
        this.hbaseSchema = hbaseSchema;
        this.tableName = hbaseSchema.getTableName();
    }
    ...
    public void openInputFormat() throws IOException {
        ...
        this.scan = buildScan(hbaseSchema);
    ...
    private static Scan buildScan(HBaseTableSchema hBaseTableSchema) {
        Scan scan = new Scan();
        ...
        for (String familyName : familyNames) {
            ...
            for (Map.Entry<String, DataType> columnInfoEntry : familyInfo.entrySet()) {
                scan.addColumn(Bytes.toBytes(familyName), Bytes.toBytes(columnInfoEntry.getKey()));
            }
        }
        return scan;
    }
