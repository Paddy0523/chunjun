...
import com.dtstack.flinkx.connector.hbase2.converter.HbaseRowConverter;
import com.dtstack.flinkx.connector.hbase2.source.HBaseInputFormatBuilder;
import com.dtstack.flinkx.connector.hbase2.table.lookup.HBaseAllTableFunction;
import com.dtstack.flinkx.connector.hbase2.table.lookup.HBaseLruTableFunction;
...
public class HBaseDynamicTableSource
    ...
    public ScanRuntimeProvider getScanRuntimeProvider(ScanContext runtimeProviderContext) {
        ...
        HBaseInputFormatBuilder builder = HBaseInputFormatBuilder.newBuild(hbaseSchema);
    ...
    public LookupRuntimeProvider getLookupRuntimeProvider(LookupContext context) {
        ...
        if (lookupConf.getCache().equalsIgnoreCase(CacheType.LRU.toString())) {
            return ParallelAsyncTableFunctionProvider.of(
                    new HBaseLruTableFunction(lookupConf, hbaseSchema, hBaseConf, rowConverter),
                    lookupConf.getParallelism());
        }
        return ParallelTableFunctionProvider.of(
                new HBaseAllTableFunction(lookupConf, hbaseSchema, hBaseConf),
                lookupConf.getParallelism());
    }
