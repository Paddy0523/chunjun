...
public class TimestampColumnSerializerTest extends SerializerTestBase<AbstractBaseColumn> {
    ...
    protected AbstractBaseColumn[] getTestData() {
        return new AbstractBaseColumn[] {
            new NullColumn(),
            new TimestampColumn(100),
            new TimestampColumn(new Timestamp(System.currentTimeMillis()))
        };
    }

    public static class TimestampColumnChecker
            implements DeeplyEqualsChecker.CustomEqualityChecker {

        @Override
        public boolean check(Object o1, Object o2, DeeplyEqualsChecker checker) {
            if (o1 instanceof TimestampColumn && o2 instanceof TimestampColumn) {
